...
| 文件（相对本 README） | 说明 |
|------|------|
| [`demos/channel-transfer-new.html`](./demos/channel-transfer-new.html) | 渠道调拨：壳层 + 列表 + 编辑抽屉。 |
| [`demos/channel-transfer-view.html`](./demos/channel-transfer-view.html) | 查看类**形态一**：列表 + 连续只读 KV 抽屉。 |
